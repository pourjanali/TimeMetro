...
(در این بخش می‌توانید اسکرین‌شات‌هایی از برنامه خود قرار دهید)

<div align="center">
  <img src="https://placehold.co/800x600/111827/7f8ea0?text=اسکرین‌شات+برنامه" alt="نمایی از برنامه" width="70%">
  <p><i>نمای اصلی برنامه در موبایل</i></p>
</div>
